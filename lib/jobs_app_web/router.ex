defmodule JobsAppWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {JobsAppWeb.Layouts, :root}
  ...
  # scope "/api", JobsAppWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:jobs_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: JobsAppWeb.Telemetry
